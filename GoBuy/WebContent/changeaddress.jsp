		...
		<div style="width:1198px;length:544px;">
			...
			<div id=1 style="width:988px;length:544px;float:left;">
				...
				<div id=1_2 style="width:988px;length:240px;border:0px;padding-left:150px;padding-bottom:60px;padding-top:30px;border-bottom:2px;border-bottom-style:solid">
					<table><form action="changeAd" method="post">
						<tr>
							<td>
								当前收货地址：
							</td>
							<td>
								<input type="text" value="<%=login.getAddress() %>" name="nowAddress" readonly="true" style="width:250px">
							</td>
							<td>
						...
						<tr>
							...
							<td>
								<input type="text" name="confirmAddress" style="width:250px">
							</td>
							<td>
								<input type="submit" value="确认添加/更改" style="box-sizing:content-box;font-size:20px">
							</td>
						</tr>
					</table>
				</div>
