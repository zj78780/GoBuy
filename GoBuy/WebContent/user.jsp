				...
				<div id=1_2 style="width:988px;length:240px;border:0px;padding-left:150px;padding-bottom:60px;padding-top:30px;border-bottom:2px;border-bottom-style:solid">
					<table>
						<tr>
							...
							<td>
								<input type="password" value="<%=login.getPassword() %>" name="Password" readonly="true">
							</td>
							<td>
								<input type="button" value="更改密码" id="changePassword" style="box-sizing:content-box;font-size:20px" onclick="javascript:window.location.href='changepassword.jsp';">
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type="text" value="<%=login.getEmail() %>" name="Email" readonly="true">
							</td>
							<td>
								<input type="button" value="更改邮箱" id="changeEmail" style="box-sizing:content-box;font-size:20px" onclick="javascript:window.location.href='changeemail.jsp';">
							</td>
						</tr>
						<tr>
							<td>
							...
							<td>
								<input type="text" value="<%=login.getAddress() %>" name="Address" readonly="true" style="width:250px">
							</td>
							<td>
								<input type="button" value="添加/更改收获地址" id="changeAddress" style="box-sizing:content-box;font-size:20px" onclick="javascript:window.location.href='changeaddress.jsp';">
							</td>
						</tr>
						<tr>
							<td>
