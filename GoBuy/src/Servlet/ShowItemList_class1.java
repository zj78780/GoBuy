...
/**
 * Servlet implementation class ShowItemList_class1
 */
@WebServlet("/ShowItemList_class1")
public class ShowItemList_class1 extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowItemList_class1() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			showBean=(ItemList)session.getAttribute("show_1");
			if(showBean==null){
				showBean = new ItemList();
				session.setAttribute("show_1", showBean);
			}
		}
		catch(Exception exp){
			showBean=new ItemList();
...
//		System.out.println("class: "+showBean.getPclass()+"\n");//
		...
		try{
			...
			String query="select * from Test.item where class1='"+showBean.getPclass()+"'";
		...
		RequestDispatcher dispatcher=request.getRequestDispatcher("itemlist_class1.jsp");
